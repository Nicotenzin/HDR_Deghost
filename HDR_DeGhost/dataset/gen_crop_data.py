...
# 预处理数据创建所需要的训练数据sig17_training_crop{}_stride{}，图像大小和stride可以指定
...
# ../data/sig17_training_crop{}_stride{}
...
def main():
    ...
    for scene in all_scenes:
        ...
        # cropped_data : patches list of each training case.
        # Save each patch with four images and exposure times as a file.
