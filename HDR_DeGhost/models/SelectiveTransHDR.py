...
class SelectiveTransHDR(nn.Module):
    def __init__(self,
                 in_channels=6,
                 out_channels=3,
                 dim=48,
        ...
        super(SelectiveTransHDR, self).__init__()
        ...
        # reconstruction
        self.norm1 = LayerNorm(dim//3, LayerNorm_type)
        self.norm2 = LayerNorm(dim//3, LayerNorm_type)
        self.norm3 = LayerNorm(dim//3, LayerNorm_type)
        self.conv_dia1 = nn.Conv2d(in_channels=dim//3, out_channels=dim//3, kernel_size=3, padding=1)
        self.conv_dia2 = nn.Conv2d(in_channels=dim//3, out_channels=dim//3, kernel_size=3, padding=2, dilation=2)
